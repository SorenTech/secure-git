...
# Signature Verification (via Branch Protection Rules)
    ...
    '''
    If the API object indicates that the repostory requires signed commits, this will trigger a call to the Repository.signature_verification method with the value "true" to update the repo object.
    '''
...
# Secret Blocking (?)
    def secret_scanning(self):
     '''
    If the API object indicates that the repostory performs scanning to block committing secrets, this will trigger a call to the Repository.secret_blocking method with the value "true" to update the repo object.
    '''
...
# Security Scanning (?)
    def security_scanning(self):
     '''
    If the API object indicates that the repostory performas automatic security scanning, this will trigger a call to the Repository.security_scanning method with the value "true" to update the repo object.
    '''
